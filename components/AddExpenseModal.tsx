    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Record New Expense">
      <form action={async (formData) => {
        ...
        <div>
          ...
          <input type="text" name="purpose" required className={inputClasses} />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Personnel Name</label>
          <input type="text" name="personnel" required className={inputClasses} />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Amount ($)</label>
            <input type="number" name="amount" min="0" step="0.01" required className={inputClasses} />
          </div>
          <div>
        ...
        <div>
          ...
          <textarea name="description" rows={3} className={inputClasses}></textarea>
        </div>
